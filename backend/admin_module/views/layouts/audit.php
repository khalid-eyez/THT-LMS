...
<head>
    ...
    $this->registerCss('canvas {width: 100% !important;height: 1000px;}');
...
<div class="wrapper p-0 m-0">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake rounded" src="<?php echo Yii::getAlias('@web/img/logo.png'); ?>" alt="LOGO" height="75" width="100">
  </div> 
     <!-- Navbar 
      ...
      <div class="container-fluid">
        <div class="row mb-2" style="font-size:17px; background-color:#f1f1f1">
          ...
          <i class="fa fa-bars mt-2 tog" data-widget="pushmenu" href="#" role="button"></i>
           <?= Page::widget([
             'pageTitle'=>isset($this->params['pageTitle'])? $this->params['pageTitle']: 'Audit Module'
           ])?>
...
<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
    ...
    <!-- Main content -->
    <section class="content mt-0 mycont" style="font-family:regulartext!important;overflow-x:auto">
      <div class="container-fluid ">
      <?= $content ?>
      </div>
      </section>
