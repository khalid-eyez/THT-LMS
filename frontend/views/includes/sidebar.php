...
<div class="sidebar1 mt-2 d-none d-md-block">
  ...
  <a href="<?=Url::to('/member/dashboard')?>" class="menuitem dashboard"><i class=" nav-icon fas fa-th"></i> <span class="mn">Dashboard</span></a>
  ...
  <a href="<?=Url::to('/branch')?>" class="branches"><i class="nav-icon fa fa-list"></i><span class="mn"> Branches</span></a>
  <?php } ?>
