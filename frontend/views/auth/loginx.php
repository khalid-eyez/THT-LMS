    ...
    <div class="card border border-white shadow-sm m-0 bg-white rounded p-0" style="height:100%">
    <div class="card-body text-center m-0">
      <div class="container p-0"><i class="fa fa-user-circle fa-3x text-primary mt-3 mb-3"></i></div>
  ...
  -->
           ...
           <div class="col-md-4 mr-auto ml-auto">
             <?= Html::submitButton('<i class="fas fa-sign-in-alt"></i> Login', ['class'=>'btn btn-primary btn-sm btn-block'])?>
           </div>
