...
<div class="container-fluid   p-0 d-flex justify-content-center text-center mt-5" style="border-radius:7px 7px 7px 7px!important">
  <div class="row shadow-lg bg-white login mt-5" style="width:30%; border-radius:6px 6px 6px 6px !important">
