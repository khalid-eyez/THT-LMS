  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     <div class="modal-header bg-success pl-4 p-1"><div class="modal-title ml-1"><i class='fa fa-upload'></i> Upload Document</div></div>
      ...
      $form = ActiveForm::begin(['method'=>'post','action'=>Url::to(['/filecabinet/upload-document','label'=>urlencode(base64_encode($label->prefID))]),'options' => ['data-pjax' => true,'enctype'=>'multipart/form-data']]);
      ?>
        <div class="row">
        <div class="col-md-12">
