...
<div style="width:100%; font-family: sans-serif; font-size:12px;">
    ...
    <div style="margin-bottom:20px;">
        <table width="100%" cellpadding="6" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= Yii::$app->formatter->asDecimal(abs($total), 2) ?></td>
            </tr>
    ...
    <div style="margin-bottom:30px;">
        <table width="100%" cellpadding="8" cellspacing="0">
            <tr>
                <td width="40%" style="font-size:14px;"><strong>TOTAL AMOUNT</strong></td>
                <td style="font-size:16px; font-weight:bold;">
                    <?= Yii::$app->formatter->asDecimal(abs($total), 2) ?> TZS
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="margin-top:30px; text-align:center; font-size:10px; color:#666;">
        This document is system generated and serves as proof of payment.
    </div>
