            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-white">
                <div class="wizard-wrap-int">
                    <div class="loan-search-bar" style="margin-bottom:20px;">
                        ...
                        <a class="btn btn-primary rep" href="/cashbook/cashbook/cashbook-pdf"><i class="fa fa-file-pdf-o"></i> PDF</a>
                        <a class="btn btn-primary rep" href="/cashbook/cashbook/cashbook-excel"><i class="fa fa-file-excel-o"></i> EXCEL</a>
                        </div>
                         </div>
                    </div>
                    <div class="cashbook">
...
$(document).ready(function () {
    ...
    $('.loan-search-bar form').on('submit', function (e) {
        ...
        var url  = form.attr('action') 
                    ? form.attr('action') 
                    : '/cashbook/cashbook/cashbook-reporter';
...
$('.loan-search-bar').on('click', '.rep', function (e) {
    ...
    var dateInput = form.find('input[name="Cashbook[date_range]"]');
    ...
    postData['Cashbook[date_range]'] = dateRange;
