...
$totalInterest = ($cashbook->credit > 0)
    ? $cashbook->credit
    : $cashbook->debit;
?>
...
<div style="width:100%; font-family: sans-serif; font-size:12px;">
    ...
    <div style="text-align:center; margin-bottom:25px;">
        <h2 style="margin:0;">Interest Payment Receipt</h2>
        <div style="font-size:11px; color:#555;">
            Official confirmation of interest payment
        </div>
    </div>
    ...
    <div style="margin-bottom:20px;">
        <table width="100%" cellpadding="6" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= Yii::$app->formatter->asDecimal(abs($totalInterest), 2) ?></td>
            </tr>
        ...
        <table width="100%" cellpadding="8" cellspacing="0">
            <tr>
                ...
                <td style="font-size:16px; font-weight:bold;">
                    <?= Yii::$app->formatter->asDecimal(abs($totalInterest), 2) ?> TZS
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="margin-top:30px; text-align:center; font-size:10px; color:#666;">
        This document is system generated and serves as proof of interest payment.
    </div>
