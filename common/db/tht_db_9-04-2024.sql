...
(185, 0.000, 109, 1, 90),
(186, 0.000, 109, 1, 91),
(187, 2000.000, 109, 1, 92),
(188, 0.000, 110, 2, 89),
(189, 0.000, 110, 2, 90),
(190, 0.000, 110, 2, 91),
(191, 25000.000, 110, 2, 92),
(192, 0.000, 111, 3, 89),
(193, 0.000, 111, 3, 90),
(194, 0.000, 111, 3, 91),
(195, 2000.000, 111, 3, 92),
(196, 0.000, 112, 4, 89),
(197, 0.000, 112, 4, 90),
(198, 0.000, 112, 4, 91),
(199, 35000.000, 112, 4, 92);
...
(43, 'chakula', 200000, 92, 'projecting'),
(44, 'meeting', 100000, 92, 'projecting');
...
(109, 23, 1, 4000, '2024-04-07 10:47:03'),
(110, 23, 2, 50000, '2024-04-07 18:03:41'),
(111, 23, 3, 4000, '2024-04-07 21:20:49'),
(112, 23, 4, 70000, '2024-04-08 10:32:09');
...
(25, 47, 1, 15000, '2024-04-08', NULL, 'THTU0506');
...
(46, 43, 200000, '2024-04-07 21:25:56', 6380);
...
(6373, 'THTU_ADMIN', 'AFujXxw5biTnwJcSNrjovcTixG-GGsB8', '$2y$13$Be/h1TGF42BuGX/T1Gx20OwdpP/S4sejcSPAcqL05Qoe4Q/8tOsmO', '', 10, 0, 1712586324, 'RK8L3JdasioISkk4Xe8veLgXDqIwFSUs_1710859274', '2024-04-08 17:25:24'),
(6380, 'hq@gmail.com', 'zQlgozCe0kvbebeAv16j4W1b7x55RQ5c', '$2y$13$uxRoW2KSSm9aDJ/hkgYXM.ZutCPudJCn/ecydzUpRcq/4hDql7hOG', NULL, 10, 1711010350, 1712664714, 'u52BtwjKdXLCFQQ1PfM9HISWAPbVNHr0_1711176383', '2024-04-09 15:11:53'),
(6381, 'day@gmail.com', '6kt3bPhPPoL9mg3wxDodZyNziSPtm_pZ', '$2y$13$x8e5pSAJRbTHVK5i6jEruOdA6t4jHK/5rlU5k0VA123kvBn01YDvq', NULL, 10, 1711119432, 1712590102, 'ChMEfn8yTzjRR3aGMMgalJvGS3mB924P_1711293641', '2024-04-08 18:28:22'),
...
--
ALTER TABLE `annualbudget`
  MODIFY `budgetID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `branch_annual_budget`
  MODIFY `bbID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT for table `branch_monthly_revenue`
--
ALTER TABLE `branch_monthly_revenue`
  MODIFY `revenueID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;

--
-- AUTO_INCREMENT for table `budgetprojections`
--
ALTER TABLE `budgetprojections`
  MODIFY `projID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `budgetyear`
--
ALTER TABLE `budgetyear`
  MODIFY `yearID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `itemizedprojections`
  MODIFY `ipID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `monthlyincome`
  MODIFY `incomeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `otherincomes`
  MODIFY `incomeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `payabletransactions`
--
ALTER TABLE `payabletransactions`
  MODIFY `transID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `receivabletransactions`
--
ALTER TABLE `receivabletransactions`
  MODIFY `transID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `takeover`
  MODIFY `tvID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_audit_entry`
--
ALTER TABLE `tbl_audit_entry`
  MODIFY `audit_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210366;
