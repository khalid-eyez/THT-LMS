...
(8, 6381, 'TH001', 'safina', NULL, 'mussa', 'safina@gmail.com', '0755189736', 4, 'm');
...
(6373, 'THTU_ADMIN', 'AFujXxw5biTnwJcSNrjovcTixG-GGsB8', '$2y$13$Be/h1TGF42BuGX/T1Gx20OwdpP/S4sejcSPAcqL05Qoe4Q/8tOsmO', '', 10, 0, 1712135145, 'RK8L3JdasioISkk4Xe8veLgXDqIwFSUs_1710859274', '2024-04-03 12:05:45'),
(6380, 'hq@gmail.com', 'zQlgozCe0kvbebeAv16j4W1b7x55RQ5c', '$2y$13$uxRoW2KSSm9aDJ/hkgYXM.ZutCPudJCn/ecydzUpRcq/4hDql7hOG', NULL, 10, 1711010350, 1711652029, 'u52BtwjKdXLCFQQ1PfM9HISWAPbVNHr0_1711176383', '2024-03-28 21:53:49'),
...
(6383, 'kazi@gmail.com', 'y_CkzeGFfnJTrPd5Y_J4Vh0Kr7HXTupZ', '$2y$13$6YaaL.TpMb8YBEROY0/6bujwlr2JC/Ovio/pRsJhONL/XORtbdzHa', NULL, 10, 1711550043, 1712134216, 'prdRshg1XktMI7ee4LIjMJJp7sn505Zv_1711550086', '2024-04-03 11:50:16'),
...
--
ALTER TABLE `branch_monthly_revenue`
  MODIFY `revenueID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;

--
-- AUTO_INCREMENT for table `budgetprojections`
--
ALTER TABLE `budgetprojections`
  MODIFY `projID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `itemizedprojections`
  MODIFY `ipID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `monthlyincome`
  MODIFY `incomeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `tbl_audit_entry`
  MODIFY `audit_entry_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210302;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6385;
